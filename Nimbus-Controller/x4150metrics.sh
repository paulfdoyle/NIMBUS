...
INSTANCES=$( grep london *MasterLogfile* | sort | awk -F"," '{print $2}' | uniq | wc -l )
WORKERS=$( grep london *MasterLogfile* | sort | awk -F"," '{print $1}' | uniq | wc -l )
...
LINE=$( grep london *MasterLogfile* | wc -l )
...
RESINSTANCES=$(grep london *MasterRESULT* | sort | awk -F"," '{print $2}' | uniq | wc -l)

INSTANCESLIST=$(grep london *MasterRESULT* | sort | awk -F"," '{print $2}' | uniq)
RESWORKERS=$(grep london *MasterRESULT* | sort | awk -F"," '{print $1}' | uniq | wc -l)
...
square=0
sumsquare=0
WORKERLIST=$(grep london *MasterRESULT* | sort | awk -F"," '{print $1}' | uniq)
...
REGINSTANCES=$(grep london *Reg.csv | sort | awk -F"," '{print $2}' | uniq | wc -l)
REGWORKERS=$(grep london *Reg.csv | sort | awk -F"," '{print $1}' | uniq | wc -l)

echo -n $REGINSTANCES ","
echo -n $REGWORKERS ","
REGSTARTWORKER=$(grep london *Reg.csv | sort | awk -F"," '{print $4}' | sort| uniq | awk -F " " 'NR==1 {c=$2 } END { print c }')
REGLASTWORKER=$(grep london *Reg.csv | sort | awk -F"," '{print $4}' | sort| uniq | awk -F " " 'END {print $2}')
