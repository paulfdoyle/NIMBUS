...
INSTANCES=$( grep ip-10 *MasterLogfile* | sort | awk -F"," '{print $2}' | uniq | wc -l )
WORKERS=$( grep ip-10 *MasterLogfile* | sort | awk -F"," '{print $1}' | uniq | wc -l )
...
LINE=$( grep ip-10 *MasterLogfile* | wc -l )
...
RESINSTANCES=$(grep ip-10 *MasterRESULT* | sort | awk -F"," '{print $2}' | uniq | wc -l)

INSTANCESLIST=$(grep ip-10 *MasterRESULT* | sort | awk -F"," '{print $2}' | uniq)
RESWORKERS=$(grep ip-10 *MasterRESULT* | sort | awk -F"," '{print $1}' | uniq | wc -l)
...
square=0
sumsquare=0
WORKERLIST=$(grep ip-10 *MasterRESULT* | sort | awk -F"," '{print $1}' | uniq)
...
REGINSTANCES=$(grep ip-10 *Reg.csv | sort | awk -F"," '{print $2}' | uniq | wc -l)
REGWORKERS=$(grep ip-10 *Reg.csv | sort | awk -F"," '{print $1}' | uniq | wc -l)

echo -n $REGINSTANCES ","
echo -n $REGWORKERS ","
REGSTARTWORKER=$(grep ip-10 *Reg.csv | sort | awk -F"," '{print $4}' | sort| uniq | awk -F " " 'NR==1 {c=$2 } END { print c }')
REGLASTWORKER=$(grep ip-10 *Reg.csv | sort | awk -F"," '{print $4}' | sort| uniq | awk -F " " 'END {print $2}')
